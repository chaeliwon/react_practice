...
const MyAxios = () => {
  ...
  function getData(){
    ...
    axios({
        //통신 할때 필요한 정보
        url : 'https://kobis.or.kr/kobisopenapi/webservice/rest/boxoffice/searchDailyBoxOfficeList.json?key=82ca741a2844c5c180a208137bb92bd7&targetDt=20120101',//어디랑 통신 할껀지
        //method : '',//어떤 방식으로 통신할껀지 (GET , POST)
        //data: '' //요청시 전송할 데이터 
    })
    //통신 성공시 실행할 로직
    .then((res)=>{
        ...
        //moiveData = res.data.boxOfficeResult.dailyBoxOfficeList;
