    ...
    <div>
      ...
      <div>
        <Breadcrumb className='nav_divider'>
          <Breadcrumb.Item><Link to={"/"}>회원가입</Link></Breadcrumb.Item>
          <Breadcrumb.Item><Link to={"/login"}>로그인</Link></Breadcrumb.Item>
          <Breadcrumb.Item><Link to={"/"}>장바구니</Link></Breadcrumb.Item>
        </Breadcrumb>
      </div>
          ...
          <Container fluid>
            <Navbar.Collapse id="navbarScroll" className='justify-content-around'>
              <Nav
                ...
                navbarScroll
              >
                <img className='nav_logo_img' src='https://static.oliveyoung.co.kr/pc-static-root/image/comm/h1_logo.png' />
              </Nav>
